...
public class ResultListUndoLog {
  @SerializedName("code")
  private Integer code = null;

  @SerializedName("data")
  private List<UndoLog> data = new ArrayList<UndoLog>();
  ...
  public ResultListUndoLog code(Integer code) {
    this.code = code;
    return this;
  }
  ...
  **/
  ...
  public ResultListUndoLog data(List<UndoLog> data) {
    this.data = data;
    return this;
  }

  public ResultListUndoLog addDataItem(UndoLog dataItem) {
  ...
  **/
  ...
  public List<UndoLog> getData() {
    return data;
  }

  public void setData(List<UndoLog> data) {
    this.data = data;
  }

  public ResultListUndoLog flag(Boolean flag) {
    this.flag = flag;
    return this;
  }
  ...
  **/
  ...
  public ResultListUndoLog message(String message) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ResultListUndoLog resultListUndoLog = (ResultListUndoLog) o;
    return Objects.equals(this.code, resultListUndoLog.code) &&
        Objects.equals(this.data, resultListUndoLog.data) &&
        Objects.equals(this.flag, resultListUndoLog.flag) &&
        Objects.equals(this.message, resultListUndoLog.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResultListUndoLog {\n");
