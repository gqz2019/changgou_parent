...
public class ResultListPara {
  @SerializedName("code")
  private Integer code = null;

  @SerializedName("data")
  private List<Para> data = new ArrayList<Para>();
  ...
  public ResultListPara code(Integer code) {
    this.code = code;
    return this;
  }
  ...
  **/
  ...
  public ResultListPara data(List<Para> data) {
    this.data = data;
    return this;
  }

  public ResultListPara addDataItem(Para dataItem) {
  ...
  **/
  ...
  public List<Para> getData() {
    return data;
  }

  public void setData(List<Para> data) {
    this.data = data;
  }

  public ResultListPara flag(Boolean flag) {
    this.flag = flag;
    return this;
  }
  ...
  **/
  ...
  public ResultListPara message(String message) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ResultListPara resultListPara = (ResultListPara) o;
    return Objects.equals(this.code, resultListPara.code) &&
        Objects.equals(this.data, resultListPara.data) &&
        Objects.equals(this.flag, resultListPara.flag) &&
        Objects.equals(this.message, resultListPara.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResultListPara {\n");
